	...
	<div class="wrap about-wrap theme_info_wrapper">
		...
		<?php if ( $tab == 'pro_version' ) { ?>
			<div class="pro-version-tab info-tab-content">
				<h3>
					<?php esc_html_e( 'To get these awesome features, upgrade to Envo eCommerce PRO!', 'envo-ecommerce' ); ?>
				</h3>
				<ul>
					<li><?php esc_html_e( 'Unlimited colors', 'envo-ecommerce' ); ?></li>
					<li><?php esc_html_e( '600+ Google fonts', 'envo-ecommerce' ); ?></li>
					<li><?php esc_html_e( 'New homepage widgets', 'envo-ecommerce' ); ?></li>
					<li><?php esc_html_e( 'Advertising spaces', 'envo-ecommerce' ); ?></li>
					<li><?php esc_html_e( 'Mega Menu support', 'envo-ecommerce' ); ?></li>
					<li><?php esc_html_e( 'Footer credits editor', 'envo-ecommerce' ); ?></li>
					<li><?php esc_html_e( 'And much more...', 'envo-ecommerce' ); ?></li>
				</ul>
				<p>
					<a href="<?php echo esc_url( 'https://envothemes.com/product/envo-ecommerce-pro/' ); ?>" target="_blank" class="button button-primary">
						<?php esc_html_e( 'Envo eCommerce PRO', 'envo-ecommerce' ); ?>
					</a>
				</p>
			</div>
		<?php } ?>
