 ...
 */
define( 'ENVO_ECOMMERCE_VERSION', '1.0.0' );
...
if ( !function_exists( 'envo_ecommerce_setup' ) ) :
	...
	function envo_ecommerce_setup() {
		...
		add_image_size( 'envo-ecommerce-thumbnail', 160, 120, true );
...
if ( !function_exists( 'envo_ecommerce_generate_construct_footer' ) ) :
	...
	function envo_ecommerce_generate_construct_footer() {
		...
		<div class="footer-credits-text text-center">
			...
			printf( esc_html__( 'Theme: %1$s', 'envo-ecommerce' ), '<a href="' . esc_url( 'https://envothemes.com/' ) . '">Envo eCommerce</a>' );
			?>
		</div> 
		<?php
	}
