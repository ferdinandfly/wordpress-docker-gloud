        ...
        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
            <div class="zo-portfolio-info">
                <div class="portfolio-item">
                    <label><?php esc_html_e('Client', 'zap'); ?></label>
                    <span><?php echo esc_attr($meta_data->_zo_portfolio_client) ?></span>
                </div>
                <div class="portfolio-item">
                    <label><?php esc_html_e('Date', 'zap'); ?></label>
                    <span><?php echo mysql2date('M d Y', $meta_data->_zo_portfolio_date) ?></span>
                </div>
                <div class="portfolio-item">
                    <label><?php esc_html_e('Skills', 'zap'); ?></label>
                    <span><?php echo esc_attr($meta_data->_zo_portfolio_skills) ?></span>
                </div>
                <a href="<?php echo !empty($meta_data->_zo_portfolio_url) ? $meta_data->_zo_portfolio_url : '#'; ?>" class="btn btn-primary"><?php esc_html_e('View Project', 'zap'); ?></a>
            </div>
        </div>
    </div>
