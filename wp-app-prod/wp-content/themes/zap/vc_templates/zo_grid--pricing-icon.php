...
<div class="zo-grid-wrapper zo-grid-pricing <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
        ...
        ?>
            <div class="zo-pricing-item <?php echo esc_attr($atts['item_class']);?> <?php echo ( $pricing_meta->_zo_is_feature == 1 ) ? ' pricing-feature-item' : '' ?> ">
                <div class="zo-pricing-inner">
                    <div class="zo-pricing-icon">
                        <?php if( !empty($pricing_meta->_zo_icon_font) ) : ?>
                            <i class="<?php echo esc_attr($pricing_meta->_zo_icon_font); ?>"></i>
                        <?php elseif( !empty($pricing_meta->_zo_icon_image) ) : ?>
                            <?php echo wp_get_attachment_image($pricing_meta->_zo_icon_image); ?>
                        <?php endif; ?>
                    </div>
