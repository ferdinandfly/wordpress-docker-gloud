        ...
        <div class="row">
            ...
            switch ($columns) {
                ...
                case "3 Columns":
                    ...
                    break;
                case "4 Columns":
                    $class_bootstrap = "col-xs-12 col-sm-6 col-md-6 col-lg-3";
                    break;
                case "6 Columns":
            ...
            for ($i = 1; $i <= $columns; $i++) : ?>
                ...
                <div class="<?php echo esc_attr($item_class); ?>">
                    <div class="zo-fancybox-item">
                        ...
                        <?php endif; ?>
                        <?php if( $content) : ?>
                            <div class="zo-fancy-box-content font-second" style="color: <?php echo esc_attr($zo_fancybox_content_color); ?>;">
