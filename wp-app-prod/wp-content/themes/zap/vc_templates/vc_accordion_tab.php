...
$output .= "\n\t\t\t" . '<div class="'.$css_class.'">';
    $output .= "\n\t\t\t\t" . '<h3 class="wpb_accordion_header ui-accordion-header" style="background-color: '.$zo_accordion_bg_color.';border-color: '.$zo_accordion_border_color.'"><a href="#'.sanitize_title($title).'">'. $icon .$title.'<i class="vc_tta-controls-icon vc_tta-controls-icon-plus"></i></a></h3>';
