    ...
    <div class="zo-fancyboxes-body">
        <div class="row">
            ...
            for ($i = 1; $i <= $columns; $i++) : ?>
                ...
                $image_url = '';
                if (!empty($image)) {
                    $attachment_image = wp_get_attachment_image_src($image, 'zo-blog-medium');
                    $image_url = $attachment_image[0];
                }

                ?>
                <div class="<?php echo esc_attr($item_class); ?>">
                    <div class="zo-fancybox-wrap">                        
						<?php if ($image_url): ?>
                            <div class="zo-fancy-box-image">
                                <img src="<?php echo esc_attr($image_url); ?>" alt="<?php if ($title) echo esc_attr($title); ?>"/>
                            </div>
						<?php endif; ?>
						<?php if ($icon): ?>
                            <div class="zo-fancy-box-content-icon">
                                <i class="<?php echo esc_attr($icon); ?>" style="color: <?php echo esc_attr($zo_fancybox_icon_color);?>; border: 1px solid <?php echo esc_attr($zo_fancybox_border_color);?>; font-size: <?php echo esc_attr($zo_fancybox_icon_size);?>;"></i>
                            </div>
                        <?php endif; ?>
