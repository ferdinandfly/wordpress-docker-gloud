...
?>
<div class="<?php echo esc_attr($class_link); ?> zo-fancyboxes-wraper zo-fancybox-service-style-2 <?php echo esc_attr($atts['template']); ?>" id="<?php echo esc_attr($atts['html_id']); ?>">
    <?php if ($atts['title'] != ''): ?>
    ...
    <div class="zo-fancyboxes-body">
        <div class="row">
            ...
            <div class="<?php echo esc_attr($item_class); ?>">
                ...
                <?php if ($atts['button_text'] != '' && (isset($atts['button_link' . $i])&&$atts['button_link' . $i]!='')): ?>
                    <div class="zo-fancyboxes-readmore">
                        ...
                        ?>
                        <a style="background-color: <?php echo esc_attr($btn_bg_color); ?>; border-color: <?php echo esc_attr($btn_border_color); ?>; color: <?php echo esc_attr($text_button_color); ?>" href="<?php echo esc_url($button_link); ?>" class="<?php echo esc_attr($class_btn); ?>"><?php echo esc_attr($atts['button_text']); ?><i class="fa fa-chevron-circle-right"></i></a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
