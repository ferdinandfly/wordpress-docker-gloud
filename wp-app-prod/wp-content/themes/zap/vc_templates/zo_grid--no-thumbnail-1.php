...
?>
<div class="zo-grid-wraper zo-grid-no-thumbnail-1 <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
            ...
            <div class="zo-grid-item <?php echo esc_attr($atts['item_class']);?>" data-groups='[<?php echo implode(',', $groups);?>]'>
                <div class="zo-service-inner">
                    ...
                    <div class="zo-grid-button">
                        <a title="<?php the_title(); ?>" href="<?php the_permalink() ?>" class="btn btn-gray-transparent  btn-border-2 btn-readmore" ><?php esc_html_e("Order Services", 'zap'); ?></a>
                    </div>
                </div>
            </div>
            <?php
