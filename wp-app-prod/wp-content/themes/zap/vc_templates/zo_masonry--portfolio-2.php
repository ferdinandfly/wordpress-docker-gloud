    ...
    <div class="row zo-masonry">
        ...
        <div class="zo-masonry-item item-w<?php echo esc_attr($size['width']); ?> item-h<?php echo esc_attr($size['height']); ?>"
             data-groups='[<?php echo implode(',', $groups);?>]' data-index="<?php echo esc_attr($i); ?>" data-id="<?php echo esc_attr($atts['post_id']); ?>">
                ...
                ?>
                <article id="post-<?php the_ID(); ?>" <?php post_class('zo-portfolio-masonry-2'); ?> style="background-image: url('<?php echo esc_url($thumbnail); ?>')">
                    <div class="zo-portfolio-overlay">
                        ...
                        <a class="readmore" title="<?php the_title(); ?>" href="<?php the_permalink() ?>" rel=""><i class="fa fa-arrow-circle-o-right"></i></a>
                    </div>
                </article>
            </div>
            <?php
