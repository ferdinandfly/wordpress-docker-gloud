				...
				<div class="zo-grid-wrap">
					...
					<div class="zo-grid-info">
						...
						<?php if($team_position):?>
							<div class="zo-grid-position font-second font-style-italic">
					...
					<?php if(isset($zo_meta_data->_zo_socials) && !empty($zo_meta_data->_zo_socials)): ?>
						<div class="zo-grid-socials">
							...
							<?php						
								...
								<li>
									<a href="<?php echo do_shortcode($item->link);?>" data-original-title="<?php echo do_shortcode($item->title);?>" data-placement="bottom" data-rel="tooltip" target="_blank">
