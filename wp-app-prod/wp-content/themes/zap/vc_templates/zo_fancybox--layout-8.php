...
?>
<div class="<?php echo esc_attr($class_link); ?> zo-fancyboxes-wraper zo-fancybox-layout-8 <?php echo esc_attr($atts['template']); ?>" id="<?php echo esc_attr($atts['html_id']); ?>">
    <?php if ($atts['title'] != ''): ?>
...
<style type="text/css">
    .<?php echo esc_attr($class_link); ?>.zo-fancybox-layout-8 .zo-fancyboxes-readmore a:hover {
