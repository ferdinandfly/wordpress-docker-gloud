...
?>
<div class="<?php echo esc_attr($class_link); ?> zo-fancyboxes-wraper zo-fancybox-layout-3 <?php echo esc_attr($atts['template']); ?>" id="<?php echo esc_attr($atts['html_id']); ?>">
    <?php if ($atts['title'] != ''): ?>
    ...
    <div class="zo-fancyboxes-body">
        <div class="row">
            ...
            $zo_fancybox_border_size = isset($atts['zo_fancybox_border_size']) ? $atts['zo_fancybox_border_size'] : '';
			...
			$btn_bg_color_hover = '';
            $item_class = 'zo-fancy-box-item ' . $class_bootstrap . ' ' . $zo_fancybox_border_size;
...
<?php if(isset($text_button_color_hover) && !empty($text_button_color_hover) || isset($btn_border_color_hover) && !empty($btn_border_color_hover) || isset($btn_bg_color_hover) && !empty($btn_bg_color_hover) ){?>
	<style type="text/css">	
		.<?php echo esc_attr($class_link); ?>.zo-fancybox-layout-default .zo-fancyboxes-readmore a:hover {
			<?php if(isset($text_button_color_hover) && !empty($text_button_color_hover) ){?>color: <?php echo esc_attr($text_button_color_hover); ?> !important;<?php }?>
			<?php if(isset($btn_border_color_hover) && !empty($btn_border_color_hover) ){?>border-color: <?php echo esc_attr($btn_border_color_hover); ?> !important;<?php }?>
			<?php if(isset($btn_bg_color_hover) && !empty($btn_bg_color_hover) ){?>background-color: <?php echo esc_attr($btn_bg_color_hover); ?> !important;<?php }?>
		}
	</style>
<?php }?>