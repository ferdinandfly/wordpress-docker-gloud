<?php
	$params = array(
		...
		array(
			"type" => "dropdown",
			"heading" => esc_html__("Filter Style",'zap'),
        ...
        array(
            "type" => "textfield",
            "heading" => esc_html__("Team Button More Text",'zap'),
        ...
        array(
            "type" => "iconpicker",
            "heading" => esc_html__("Team Button More Icon",'zap'),
        ...
        array(
            "type" => "textfield",
            "heading" => esc_html__("Team Button Link",'zap'),
