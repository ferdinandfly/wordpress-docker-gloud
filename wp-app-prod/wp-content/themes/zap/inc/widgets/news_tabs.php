...
class WW_News_Tabs_Widget extends WP_Widget {
    ...
    function __construct() { //php 7.0
        parent::__construct(
                'ww_news_tabs', esc_html__('ZO News Tab Widget', 'zap'), array('description' => esc_html__('Popular post, recent post and comments.', 'zap'),)
        );
    }
            ...
            <div class="tab-hold tabs-wrapper">
                <ul id="tabs" class="nav nav-tabs clearfix">
                    <?php if ($show_popular_posts == 'true'): ?>
                        <li class="active"><a href="#tab1" data-toggle="tab"><?php echo esc_html__('Popular', 'zap'); ?></a></li>
                    <?php endif; ?>
                    <?php if ($show_recent_posts == 'true'): ?>
                        <li><a href="#tab2" data-toggle="tab"><?php echo esc_html__('Recent', 'zap'); ?></a></li>
                    <?php endif; ?>
                    <?php if ($show_comments == 'true'): ?>
                        <li><a href="#tab3" data-toggle="tab"><?php echo esc_html__('Comments', 'zap'); ?></a></li>
                    <?php endif; ?>
                </ul>
