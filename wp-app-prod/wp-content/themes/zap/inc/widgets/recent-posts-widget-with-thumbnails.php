...
class Zo_Recent_Posts_Widget_With_Thumbnails extends WP_Widget {
	...
	function __construct() {
        ...
        parent::__construct(
            ...
            esc_html__('Recent Posts With Thumbnails', 'zap'), // Name
            array('description' => esc_html__('List of your site&#8217;s most recent posts, with clickable title and thumbnails.', 'zap'),) // Args
        );
	...
	function widget( $args, $instance ) {
		...
		<?php while ( $r->have_posts() ) : $r->the_post(); ?>
			<li>
				...
				<!-- Btn read mor -->
				<a href="<?php the_permalink(); ?>" class="btn btn-green btn-readmore-2"><?php esc_html_e('Read More', 'zap');?></a>
				</li>
		<?php endwhile; ?>
		</ul>
...
<?php
	...
	function form( $instance ) {
		...
		?>
		<p><label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:', 'zap' ); ?></label>
		<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr($title); ?>" /></p>

		<p><label for="<?php echo esc_attr($this->get_field_id( 'number_posts' )); ?>"><?php esc_html_e( 'Number of posts to show:', 'zap' ); ?></label>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'show_date' )); ?>"><?php esc_html_e( 'Display post date?', 'zap' ); ?></label></p>

		<h4><?php esc_html_e( 'Thumbnail Options', 'zap' ); ?>:</h4>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'show_thumb' )); ?>"><?php esc_html_e( 'Display post featured image?', 'zap' ); ?></label></p>
		
		<p><label for="<?php echo esc_attr($this->get_field_id( 'thumb_width' )); ?>"><?php esc_html_e( 'Width of thumbnail', 'zap' ); ?>:</label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id( 'thumb_height' )); ?>"><?php esc_html_e( 'Height of thumbnail', 'zap' ); ?>:</label>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'keep_aspect_ratio' )); ?>"><?php esc_html_e( 'Use aspect ratios of original images?', 'zap' ); ?> <em><?php esc_html_e( 'If checked the given width is used to determine the height of the thumbnail automatically. This option also supports responsive web design.', 'zap' ); ?></em></label></p>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'hide_title' )); ?>"><?php esc_html_e( 'Do not show title?', 'zap' ); ?> <em><?php esc_html_e( 'Make sure you set a default thumbnail for posts without a thumbnail, otherwise there will be no link.', 'zap' ); ?></em></label> </p>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'try_1st_img' )); ?>"><?php esc_html_e( "Try to use the post's first image if post has no featured image?", 'zap' ); ?></label></p>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'only_1st_img' )); ?>"><?php esc_html_e( 'Use first image only, ignore featured image?', 'zap' ); ?></label></p>
		...
		<label for="<?php echo esc_attr($this->get_field_id( 'use_default' )); ?>"><?php esc_html_e( 'Use default thumbnail if no image could be determined?', 'zap' ); ?></label></p>
		
		<p><label for="<?php echo esc_attr($this->get_field_id( 'default_url' )); ?>"><?php esc_html_e( 'URL of default thumbnail (start with http://)', 'zap' ); ?>:</label>
