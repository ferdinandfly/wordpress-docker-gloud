...
class ZO_Recent_Post_Widget_V2 extends WP_Widget {
    ...
    function __construct() { //php 7.0
        parent::__construct(
                'zo_recent_post_v2',
            esc_html__('ZO Recent Posts','zap'),
            array('description' => esc_html__('Recent Posts Widget.', 'zap'),)
        );
    }
    ...
    function widget($args, $instance) {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? esc_html__('Recent Posts', 'zap' ) : $instance['title'], $instance, $this->id_base);
    ...
    function form($instance) {
        ...
        ?>
        <p>
            <label for="<?php echo ''.$this->get_field_id('title'); ?>"><?php esc_html_e( 'Title:', 'zap' ); ?></label>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id('title') ); ?>" name="<?php echo esc_attr( $this->get_field_name('title') ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
        </p>
        <p>
            <label for="<?php echo ''.$this->get_field_id('show_date'); ?>"><?php esc_html_e( 'Show date:', 'zap' ); ?></label>
        ...
        <p>
            <label for="<?php echo ''.$this->get_field_id('show_decs'); ?>"><?php esc_html_e( 'Show Description:', 'zap' ); ?></label>
        ...
        <p>
            <label for="<?php echo ''.$this->get_field_id('show_category'); ?>"><?php esc_html_e( 'Show Category:', 'zap' ); ?></label>
        ...
        <p>
            <label for="<?php echo ''.$this->get_field_id('number'); ?>"><?php esc_html_e( 'Number of products to show:', 'zap' ); ?></label>
