...
class ZO_Social_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            ...
            esc_html__('Social', 'zap'), // Name
            array('description' => esc_html__('Social Widget', 'zap'),) // Args
        );
    }
    ...
    function widget($args, $instance) {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? esc_html__('Social', 'zap' ) : $instance['title'], $instance, $this->id_base);
        }
    ...
    function form( $instance ) {
         ...
         ?>
         <p><label for="<?php echo esc_url($this->get_field_id('title')); ?>"><?php esc_html_e( 'Title:', 'zap' ); ?></label>
         <input class="widefat" id="<?php echo esc_attr( $this->get_field_id('title') ); ?>" name="<?php echo esc_attr( $this->get_field_name('title') ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" /></p>

         <p><label for="<?php echo esc_url($this->get_field_id('style')); ?>"><?php esc_html_e( 'Style:', 'zap' ); ?></label>
         <select class="widefat" id="<?php echo esc_attr( $this->get_field_id('style') ); ?>" name="<?php echo esc_attr( $this->get_field_name('style') ); ?>">
            <option value="default"<?php if( $style == 'default' ){ echo 'selected="selected"';} ?>><?php esc_html_e('Default', 'zap'); ?></option>
            <option value="style-1"<?php if( $style == 'style-1' ){ echo 'selected="selected"';} ?>><?php esc_html_e('Square', 'zap'); ?></option>
            <option value="style-2"<?php if( $style == 'style-2' ){ echo 'selected="selected"';} ?>><?php esc_html_e('Rounded Square', 'zap'); ?></option>
            <option value="style-3"<?php if( $style == 'style-3' ){ echo 'selected="selected"';} ?>><?php esc_html_e('Circle', 'zap'); ?></option>
            <option value="style-4"<?php if( $style == 'style-4' ){ echo 'selected="selected"';} ?>><?php esc_html_e('Box Style 1', 'zap'); ?></option>
            <option value="style-7"<?php if( $style == 'style-7' ){ echo 'selected="selected"';} ?>><?php esc_html_e('Box Style 2', 'zap'); ?></option>
            <option value="style-5"<?php if( $style == 'style-5' ){ echo 'selected="selected"';} ?>><?php esc_html_e('No List', 'zap'); ?></option>
            <option value="style-6"<?php if( $style == 'style-6' ){ echo 'selected="selected"';} ?>><?php esc_html_e('Circle Border', 'zap'); ?></option>
         </select>
         </p>

         <p><label for="<?php echo esc_url($this->get_field_id('align')); ?>"><?php esc_html_e( 'Content Align:', 'zap' ); ?></label>
         <select class="widefat" id="<?php echo esc_attr( $this->get_field_id('align') ); ?>" name="<?php echo esc_attr( $this->get_field_name('align') ); ?>">
            <option value="text-left"<?php if( $align == 'text-left' ){ echo 'selected="selected"';} ?>><?php esc_html_e('Left', 'zap'); ?></option>
            <option value="text-center"<?php if( $align == 'text-center' ){ echo 'selected="selected"';} ?>><?php esc_html_e('Center', 'zap'); ?></option>
            <option value="text-right"<?php if( $align == 'text-right' ){ echo 'selected="selected"';} ?>><?php esc_html_e('Right', 'zap'); ?></option>
         </select>
         </p>

         <p><label for="<?php echo esc_url($this->get_field_id('icon_facebook')); ?>"><?php esc_html_e( 'Icon 1:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_facebook')); ?>"><?php esc_html_e( 'Link 1:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_rss')); ?>"><?php esc_html_e( 'Icon 2:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_rss')); ?>"><?php esc_html_e( 'Link 2:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_youtube')); ?>"><?php esc_html_e( 'Icon 3:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_youtube')); ?>"><?php esc_html_e( 'Link 3:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_twitter')); ?>"><?php esc_html_e( 'Icon 4:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_twitter')); ?>"><?php esc_html_e( 'Link 4:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_google')); ?>"><?php esc_html_e( 'Icon 5:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_google')); ?>"><?php esc_html_e( 'Link 5:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_skype')); ?>"><?php esc_html_e( 'Icon 6:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_skype')); ?>"><?php esc_html_e( 'Link 6:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_yahoo')); ?>"><?php esc_html_e( 'Icon 7:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_yahoo')); ?>"><?php esc_html_e( 'Link 7:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_dribbble')); ?>"><?php esc_html_e( 'Icon 8:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_dribbble')); ?>"><?php esc_html_e( 'Link 8:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_flickr')); ?>"><?php esc_html_e( 'Icon 9:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_flickr')); ?>"><?php esc_html_e( 'Link 9:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_linkedin')); ?>"><?php esc_html_e( 'Icon 10:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_linkedin')); ?>"><?php esc_html_e( 'Link 10:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_vimeo')); ?>"><?php esc_html_e( 'Icon 11:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_vimeo')); ?>"><?php esc_html_e( 'Link 11:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_pinterest')); ?>"><?php esc_html_e( 'Icon 12:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_pinterest')); ?>"><?php esc_html_e( 'Link 12:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_github')); ?>"><?php esc_html_e( 'Icon 13:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_github')); ?>"><?php esc_html_e( 'Link 13:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('icon_instagram')); ?>"><?php esc_html_e( 'Icon 14:', 'zap' ); ?></label>
         ...
         <p><label for="<?php echo esc_attr($this->get_field_id('link_instagram')); ?>"><?php esc_html_e( 'Link 14:', 'zap' ); ?></label>
