...
<div id="zo-header-top" class="zo-header-top-2" >
    <div class="container-fluid">
        <div class="row">
            <?php if (is_active_sidebar('Header Top Sliders')): ?>
            <?php dynamic_sidebar('Header Top Sliders'); ?>
            <?php endif; ?>
        </div>
    </div>
</div>
<div id="zo-header" class="zo-main-header zo-header-2 <?php if (!$smof_data['menu_sticky']) {
    echo 'no-sticky';
