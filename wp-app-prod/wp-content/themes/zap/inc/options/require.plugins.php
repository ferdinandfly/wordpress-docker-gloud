    ...
    */
    $config = array(
        ...
        'strings'      => array(
            ...
            'installing'                      => esc_html__( 'Installing Plugin: %s', 'zap' ), // %s = plugin name.
            ...
            'activate_link'                   => _n_noop( 'Begin activating plugin', 'Begin activating plugins', 'zap' ),
            'return'                          => esc_html__( 'Return to Required Plugins Installer', 'zap' ),
            'plugin_activated'                => esc_html__( 'Plugin activated successfully.', 'zap' ),
            'complete'                        => esc_html__( 'All plugins installed and activated successfully. %s', 'zap' ), // %s = dashboard link.
